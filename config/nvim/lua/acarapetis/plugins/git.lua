    ...
    "tommcdo/vim-fubitive",
    {
        ...
        opts = {
            ...
            on_attach = function(bufnr)
                ...
                map("v", "<leader>hs", stage_selected, { desc = "Stage selected lines" })
                map("v", "<leader>hX", reset_selected, { desc = "Reset selected lines" })
                ...
                map("n", "<leader>hl", toggle_hl, { desc = "Toggle full highlighting" })
                -- stylua: ignore end
